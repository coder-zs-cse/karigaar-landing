...
const timeline = [
  ...
  {
    step: 3,
    label: "Job Queue Match",
    time: "≤15s",
    agent: "Backend",
    desc: "Polls DB → finds available worker → reserves → triggers outbound",
  },
  {
    step: 4,
  ...
  },
  {
    ...
    label: "Job Execution",
    time: "IRL",
    agent: "Worker ↔ Customer",
    desc: "Worker and customer coordinate directly via phone",
  },
  {
    step: 7,
    ...
    <div style={{ display: "flex", gap: 20, position: "relative" }}>
        ...
        {!isLast && (
          <div
            style={{
              width: 2,
              flex: 1,
              background: `linear-gradient(to bottom, ${c}40, transparent)`,
              marginTop: 4,
            }}
          />
        )}
      ...
      <div style={{ paddingBottom: isLast ? 0 : 24, flex: 1 }}>
        ...
        >
          ...
          <span style={{ fontFamily: "monospace", fontSize: 12, color: c }}>
            {item.time}
          </span>
        ...
        <div
          style={{ fontSize: 13, color: MUTED, marginTop: 4, lineHeight: 1.5 }}
        >
          {item.desc}
        </div>
      </div>
    ...
    >
      ...
      >
        <div
          style={{
            ...
            right: 0,
            height: 1,
            background: `linear-gradient(90deg, transparent, ${ACCENT}, ${PURPLE}, ${CORAL}, transparent)`,
          }}
        />
        <div
          style={{
        ...
        <div
          style={{
            ...
            height: 400,
            borderRadius: "50%",
            background: `radial-gradient(circle, ${PURPLE}06, transparent 70%)`,
          }}
        />
      ...
      >
        <div style={sectionStyle}>
          ...
          <h2 style={{ ...headingStyle, fontSize: 32, marginBottom: 40 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
            {trades.map((t, i) => (
              <span
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.borderColor = `${MUTED}20`;
